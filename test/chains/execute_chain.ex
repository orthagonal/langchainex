defmodule ExecuteChainTest do
  @moduledoc """
  Execute Chains are language chains that result in the execution of some Elixir
  source code.  They primarily operate by filling in ElixirTemplates (templates that
  contain elixir source code) with results scraped from LLMs.
  """
  use ExUnit.Case
